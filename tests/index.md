...
> - [EyeDropper API](../tests/eyedrop.html)
...
> - [Non-existent Scripts](../tests/broken.html)
...
> - [Turnstile Troubleshooter](https://browser-compat.turnstile.workers.dev/)
...
> - [data: URL](data:,Hello) (copy and paste URL in Chrome, which disallows top-level navigation to data: URLs)
